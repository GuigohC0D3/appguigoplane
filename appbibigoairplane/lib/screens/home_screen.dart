...
import 'profile_screen.dart'; // <-- ajuste o caminho se necessário
...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<String> fetchUserName() async {
    final response = await http.get(
      Uri.parse('https://suaapi.com/usuario'),
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Erro ao buscar nome do usuário');
    }
  }
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Olá, ${getFirstName(userName ?? "Visitante")}!',
